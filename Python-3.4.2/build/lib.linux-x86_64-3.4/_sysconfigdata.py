...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BINLIBDEST': '/usr/local/lib/python3.4',
 'BLDLIBRARY': 'libpython3.4m.a',
 ...
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -DNDEBUG -g -fwrapv -O3 -Wall '
           '-Wstrict-prototypes',
 'CFLAGSFORSHARED': '',
 'CFLAGS_NODIST': '',
 ...
 'CONFINCLUDEPY': '/usr/local/include/python3.4m',
 'COREPYTHONPATH': ':plat-linux',
 'COVERAGE_INFO': '/var/www/html/download_py/Python-3.4.2/coverage.info',
 'COVERAGE_REPORT': '/var/www/html/download_py/Python-3.4.2/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -IInclude -I./Include',
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/usr/local /usr/local/lib /usr/local/lib/python3.4 '
             '/usr/local/lib/python3.4/lib-dynload',
 'DESTLIB': '/usr/local/lib/python3.4',
 'DESTPATH': '',
 'DESTSHARED': '/usr/local/lib/python3.4/lib-dynload',
 'DIRMODE': 755,
 ...
 'INCLUDEPY': '/usr/local/include/python3.4m',
 'INSTALL': '/usr/bin/install -c',
 'INSTALL_DATA': '/usr/bin/install -c -m 644',
 'INSTALL_PROGRAM': '/usr/bin/install -c',
 'INSTALL_SCRIPT': '/usr/bin/install -c',
 'INSTALL_SHARED': '/usr/bin/install -c -m 555',
 'INSTSONAME': 'libpython3.4m.a',
 'IO_H': 'Modules/_io/_iomodule.h',
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -shared',
 'LDFLAGS': '',
 'LDLAST': '',
 'LDLIBRARY': 'libpython3.4m.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared',
 'LDVERSION': '3.4m',
 'LIBC': '',
 'LIBDEST': '/usr/local/lib/python3.4',
 ...
 'LIBPL': '/usr/local/lib/python3.4/config-3.4m',
 ...
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/usr/local/lib/python3.4',
 ...
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_CFLAGS': '-Wno-unused-result -DNDEBUG -g -fwrapv -O3 -Wall '
              '-Wstrict-prototypes',
 'PY_CFLAGS_NODIST': '-Werror=declaration-after-statement',
 'PY_CORE_CFLAGS': '-Wno-unused-result -DNDEBUG -g -fwrapv -O3 -Wall '
 ...
 'abs_builddir': '/var/www/html/download_py/Python-3.4.2',
 'abs_srcdir': '/var/www/html/download_py/Python-3.4.2',
